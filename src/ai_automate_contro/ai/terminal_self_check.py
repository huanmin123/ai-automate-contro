...
def _check_terminal_prompt_strategy() -> dict[str, Any]:
    ...
    required_fragments = [
        ...
        "desktop plan 检查 inspect_desktop 摘要、capability_matrix、coordinate_profile、target_candidates、open_desktop、desktop_app、桌面窗口/控件/截图/等待/断言证据、桌面标注和桌面产物",
        "desktop_capture type=observe",
        "target_candidates.best_candidate",
        "candidate_id",
        "target=candidate",
