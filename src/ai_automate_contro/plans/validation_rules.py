...
ACTION_TYPES: dict[str, set[str]] = {
    ...
    "input": {"press", "type", "down", "up", "move", "click", "wheel", "tap", "swipe", "into_view", "by"},
    "capture": {"screenshot", "html", "storage_state"},
    "dialog": {"accept", "dismiss"},
    "network": {"route", "unroute", "set_extra_http_headers", "route_from_har", "route_web_socket"},
    "event": {"start", "stop", "clear", "download", "file_chooser", "popup", "request", "response"},
    ...
    "trigger": {"interval"},
    "http": {"request"},
    "sql": {"query", "scalar", "execute", "executemany", "bulk_insert", "copy", "transaction", "inspect", "import", "export"},
    "mongo": {
        "find",
        "find_one",
        "insert_one",
...
REQUIRED_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "wait": ("browser",),
    "detect_challenge": ("browser", "output"),
    "ai": ("type", "input"),
...
OUTPUT_ACTION_CATEGORIES: dict[tuple[str, str], str] = {
    ...
    ("sql", "export"): "sql",
    ("mongo", "find"): "mongo",
    ("mongo", "find_one"): "mongo",
    ("mongo", "insert_one"): "mongo",
    ("mongo", "insert_many"): "mongo",
    ("mongo", "update_one"): "mongo",
    ("mongo", "update_many"): "mongo",
    ("mongo", "delete_one"): "mongo",
    ("mongo", "delete_many"): "mongo",
    ("mongo", "aggregate"): "mongo",
    ("mongo", "command"): "mongo",
    ("mongo", "list_indexes"): "mongo",
    ("mongo", "create_index"): "mongo",
    ("mongo", "drop_index"): "mongo",
    ("redis", "get"): "redis",
    ("redis", "set"): "redis",
    ("redis", "delete"): "redis",
    ("redis", "hget"): "redis",
